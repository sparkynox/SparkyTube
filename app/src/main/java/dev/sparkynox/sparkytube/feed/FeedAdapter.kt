...
class FeedAdapter(
    ...
    fun appendItems(newItems: List<FeedVideo>) {
        ...
        val existingIds = items.mapNotNull { it.videoId }.toHashSet()
        val deduped = newItems.filter { it.videoId != null && it.videoId !in existingIds }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { item.videoId?.let(onItemClick) }
