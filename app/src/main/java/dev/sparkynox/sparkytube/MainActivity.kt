...
class MainActivity : AppCompatActivity(), JsBridge.VideoStateListener {
    ...
    /**
     * Same lightweight Toast approach showSeekFeedback uses -- no dedicated
     * overlay slider view exists yet, this at least confirms the gesture
     * registered and shows the resulting level.
     */
    private fun showGestureFeedback(label: String, percent: Int) {
        android.widget.Toast.makeText(this, "$label: $percent%", android.widget.Toast.LENGTH_SHORT).show()
    }
