...
class MainActivity : AppCompatActivity(), JsBridge.VideoStateListener {
    ...
    private fun setupCustomPlayerControls(attempt: Int = 0) {
        ...
        if (qualityGear == null || fullscreenBtn == null || playPauseBtn == null) {
    ...
    private fun setupWebView() {
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun onPageStarted(view: WebView, url: String?, favicon: android.graphics.Bitmap?) {
                ...
                val isWatchPage = url != null && Uri.parse(url).path?.startsWith("/watch") == true
                adBlockEngine.setOnWatchPage(isWatchPage)
    ...
    private fun checkCurrentUrlForVideo() {
        ...
        val isWatchPage = Uri.parse(currentUrl).path?.startsWith("/watch") == true
        adBlockEngine.setOnWatchPage(isWatchPage)
